...
IMPLEMENT(pinMode) {
  ...
  CHECK_ARGUMENT_IN_INTS(1, mode, (INPUT, OUTPUT, PWM_OUTPUT, GPIO_CLOCK, SOFT_PWM_OUTPUT, SOFT_TONE_OUTPUT, PWM_TONE_OUTPUT));
...
IMPLEMENT_EXPORT_INIT(wiringPi) {
  ...
  EXPORT_CONSTANT_INT(PWM_TONE_OUTPUT);
  ...
  EXPORT_CONSTANT_INT(PI_MODEL_3P);
